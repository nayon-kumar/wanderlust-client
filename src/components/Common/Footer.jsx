  ...
  return (
    <footer className="bg-black text-gray-400 px-4 md:px-16 py-16">
      <div className="max-w-7xl mx-auto">
        <div className="mb-12">
          <Link href="/" className="text-4xl md:text-6xl font-bold text-white">
            Wanderlust
          </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex items-center bg-gray-800 px-4 py-1 md:py-3">
              <input
                type="email"
          ...
          <div>
            ...
            <ul className="space-y-2 flex flex-col">
              ...
              <Link href="/destinations" className="w-fit">
                <li className="hover:text-white cursor-pointer">
                  Destinations
                </li>
              </Link>
              <Link href="/bookings" className="w-fit">
